...
class MediaGraphSync:
    ...
    Example:
        >>> from jellyfin_apiclient_python.media_graph_sync import MediaGraphSync
        >>> import ubelt as ub
        >>> # Given an API client
    ...
    def _init_media_folders(self):
        ...
        with pman:
            ...
            resp = client.api.library.get_media_folders.sync_detailed()
            assert resp.status_code == 200
            media_folders = resp.parsed.to_dict()
        ...
        while stack:
            ...
            if HANDLE_SPECIAL_FEATURES:
                if parent['Type'] in {'Series', 'Season'}:
                    ...
                    resp = client.api.user_library.get_special_features.sync_detailed(item_id=parent_id)
                    assert resp.status_code == 200
                    special_features = [f.to_dict() for f in resp.parsed]
    ...
    def _safe_user_items(self, *, parent, offset, perquery_limit, fields, attempts=1, base_sleep=0.5, verbose=False):
        ...
        for attempt in range(1, attempts + 1):
            try:
                ...
                print(
                    f'[MediaGraphSync] user_items failed (attempt {attempt}/{attempts}) '
        ...
        raise Exception(f'[MediaGraphSync] giving up on parent={parent_name!r} id={parent_id} after {attempts} attempts')
        # return None
    ...
    def _coerce_item_fields(self, fields):
        ...
        for field in fields:
            ...
            try:
                ...
                if self._DEBUG:
                    print(f'[MediaGraphSync] Unknown ItemField: {field_name!r}, skipping')
                continue
        return coerced
    ...
    def print(self):
        """
        Alias for :func:`MediaGraphSync.print_graph`.
        """
        self.print_graph()
